            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-1 mb-3">
                        <a href="{{route('employee.post.create')}}" class="btn btn-block btn-outline-dark">Add</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    @foreach($posts as $post)
                                        <tr>
                                            ...
                                            <td><a href="{{route('employee.post.show', $post->id)}}"><i class="far fa-eye"></i></a></td>
                                            <td><a href="{{route('employee.post.edit', $post->id)}}" class="text-success"><i class="fas fa-pen"></i></a></td>
                                            <td>
                                                <form action="{{route('employee.post.delete', $post->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
