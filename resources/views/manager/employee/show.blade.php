            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        <h1 class="m-2">{{$employee->name}}</h1>
                        <a href="{{route('manager.employee.edit', $employee->id)}}"><i class="fas fa-pen"></i></a>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    @if($employee->posts()->exists())
                        <div class="col-5">
                            <h5>{{$employee->name}}'s posts</h5>
                            <div class="card">
                                <!-- /.card-header -->
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover text-nowrap">
