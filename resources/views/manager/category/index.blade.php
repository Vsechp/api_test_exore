            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-1 mb-3">
                        <a href="{{route('manager.category.create')}}" class="btn btn-block btn-outline-dark">Add</a>
                    </div>
                </div>
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            <td>{{$category->id}}</td>
                                            <td>{{$category->name}}</td>
                                            <td><a href="{{route('manager.category.show', $category->id)}}"><i class="far fa-eye"></i></a></td>
                                            <td><a href="{{route('manager.category.edit', $category->id)}}" class="text-success"><i class="fas fa-pen"></i></a></td><td>
